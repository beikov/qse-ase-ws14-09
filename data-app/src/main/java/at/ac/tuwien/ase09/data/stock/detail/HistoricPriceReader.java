...
@Dependent
@Named("HistoricPriceReader")
public class HistoricPriceReader extends AbstractItemReader {
	private static final Logger LOG = Logger.getLogger(HistoricPriceReader.class.getName());
	@Inject
