...
public class ServerSideDatabaseAwareArquillianRunner extends AbstractDatabaseAwareArquillianRunner {
	private static int databaseAwareTestRun = 1;
	
	public ServerSideDatabaseAwareArquillianRunner(Class<?> klass) throws InitializationError {
		super(klass);
	}
