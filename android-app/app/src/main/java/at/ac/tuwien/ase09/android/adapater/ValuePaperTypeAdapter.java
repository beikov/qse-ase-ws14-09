...
public class ValuePaperTypeAdapter extends ArrayAdapter<ValuePaperType> {
    ...
    private View getView(int position, View convertView, ViewGroup parent, int layoutId){
        ...
        switch(position){
            // STOCK
            case 0: textView.setText(context.getString(R.string.stock));
                break;
            case 1: textView.setText(context.getString(R.string.fund));
                break;
            case 2: textView.setText(context.getString(R.string.stockbond));
                break;
        }
